...
export const Hero: React.FC = () => {
  return (
    <div className="relative bg-[#fbf9f4] overflow-hidden min-h-[90vh] flex items-center">
      ...
      <div className="absolute top-1/2 left-0 w-full h-full opacity-[0.03] pointer-events-none -translate-y-1/2" style={{ backgroundImage: 'radial-gradient(#036C42 1.5px, transparent 1.5px)', backgroundSize: '60px 60px' }}></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="lg:w-3/5 py-24">
          ...
          <h1 className="text-6xl lg:text-[10rem] font-serif font-bold text-[#036C42] leading-[0.85] mb-12 tracking-tight">
            HEMPRO <br /><span className="text-[#47A4B5] italic ml-4 lg:ml-12 text-[0.8em]">Hub</span>
          </h1>

          <p className="text-xl lg:text-2xl text-gray-500 font-light max-w-xl mb-16 leading-relaxed">
            Innovazione scientifica per la filiera della <span className="text-[#036C42] font-semibold">canapa alimentare</span> in Puglia. Dalla ricerca biotecnologica del <span className="text-[#036C42] font-semibold italic">CNR</span> all'impresa agricola.
          </p>
          ...
          <div className="flex flex-wrap gap-8 items-center">
            ...
            <div className="flex items-center gap-6 border-l border-gray-200 pl-8">
              <div className="flex -space-x-3">
                <div className="w-10 h-10 rounded-full border-2 border-white bg-gray-100 flex items-center justify-center text-[10px] font-bold">CN</div>
                <div className="w-10 h-10 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-[10px] font-bold">RP</div>
                <div className="w-10 h-10 rounded-full border-2 border-white bg-gray-300 flex items-center justify-center text-[10px] font-bold">+2</div>
              </div>
              <div className="text-[9px] font-bold text-gray-400 uppercase tracking-widest leading-tight">
                Progetto Multistakeholder <br /><span className="text-[#036C42]">Lead: CNR-ISPA</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="hidden lg:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-2/5">
        <div className="h-full w-full relative overflow-hidden">
          ...
          <div className="absolute bottom-20 left-10 glass p-10 rounded-[3rem] border border-white/20 shadow-2xl backdrop-blur-2xl">
            ...
            <h4 className="text-3xl font-serif font-bold text-[#036C42] mb-2 leading-tight">Varietà Certificate <br />per il Territorio</h4>
            <div className="flex gap-4 mt-8">
              <div className="w-12 h-px bg-[#036C42]/20 self-center"></div>
              <p className="text-[9px] font-bold uppercase tracking-widest text-[#036C42]/40 italic">Ricerca Agronomica CNR</p>
            </div>
          </div>
        </div>
      </div>
